...
export default function Section({ children, icon, title, subtitle }) {
  return (
    <section className="p-5 mb-6 bg-white border border-gray-200 rounded-2xl sm:p-6 dark:border-slate-800/80 dark:bg-slate-900/70">
      <div className="flex items-start gap-3">
        <div className="mt-0.5 grid min-h-9 min-w-9 place-items-center rounded-full bg-slate-900 text-white dark:bg-slate-100 dark:text-slate-900">{icon}</div>
