...
export default function VisitPreviewSection() {
  return (
    <Section title="Preview" icon={<EyeIcon className="h-4 w-4" />} subtitle="Review how your visit details will appear to clients before finalizing.">
      <div className="mt-6 grid place-items-center rounded-2xl border border-dashed border-gray-300 bg-gray-50 p-10 text-center dark:border-slate-700 dark:bg-slate-900/60">
        <div className="max-w-sm">
          <div className="mx-auto mb-3 grid h-12 w-12 place-items-center rounded-2xl border border-gray-200 bg-white text-gray-500 dark:border-slate-800 dark:bg-slate-950 dark:text-slate-400">
