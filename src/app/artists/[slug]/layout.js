        ...
        <div className="mx-auto w-full max-w-6xl px-4 pb-10 pt-6 sm:px-8">
          <div className="flex flex-col gap-6 sm:gap-8">
            <div className="-mt-16 flex items-end justify-between gap-4 sm:-mt-20">
              <div className="rounded-[28px] bg-white shadow-md dark:bg-slate-950">
                <Avatar className="h-24 w-24 rounded-2xl border border-slate-200 bg-slate-100 sm:h-28 sm:w-28 dark:border-slate-800 dark:bg-slate-900">
