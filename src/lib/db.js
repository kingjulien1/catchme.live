...
export async function getUserVisits(userId, limit = 25) {
  ...
  const visits = await sql`
    select
      ...
      visit_options.booking_status,
      visit_options.booking_method,
      visit_options.cancellation_policy,
      visit_options.appointment_only,
      visit_options.deposit_required,
      visit_options.deposit_amount,
      visit_options.price_min,
      visit_options.price_max,
      visit_options.age_policy,
      visit_options.digital_payments,
      visit_options.languages_spoken,
      visit_options.custom_requests,
      visit_options.walk_ins_welcome,
      visit_options.portfolio_photos,
      visit_options.flash_designs,
      visit_options.touch_ups_included,
      visit_options.cover_ups_accepted,
      visits.status,
