      ...
      >
        ...
        <div className="flex items-start gap-3">
          ...
          <div className="min-w-0 flex flex-col items-start">
            ...
            />
            <div
              className={`mt-2 flex items-center gap-2 overflow-x-auto whitespace-nowrap scrollbar-hide transition-all duration-300 ${
                isOpen ? "max-h-24 opacity-100" : "max-h-4 opacity-0"
            ...
            >
              ...
              {visit.bookings_open ? (
                <span
                  className={`inline-flex items-center rounded-full px-3 py-1 text-xs font-semibold ${
                    isLive ? "bg-emerald-500/20 text-emerald-200 dark:bg-emerald-500/30 dark:text-emerald-700" : "bg-emerald-100 text-emerald-700 dark:bg-emerald-500/10 dark:text-emerald-200"
                  }`}
                >
                  Bookings open
                </span>
              ...
              {visit.deposit_required ? (
                <span
                  className={`inline-flex items-center rounded-full px-3 py-1 text-xs font-semibold ${
                    isLive ? "bg-amber-500/20 text-amber-200 dark:bg-amber-500/30 dark:text-amber-700" : "bg-amber-100 text-amber-700 dark:bg-amber-500/10 dark:text-amber-200"
                  }`}
                >
                  Deposit required
                </span>
              ...
              {visit.age_18_plus ? (
                <span
                  className={`inline-flex items-center rounded-full px-3 py-1 text-xs font-semibold ${
                    isLive ? "bg-slate-500/20 text-slate-100 dark:bg-slate-500/30 dark:text-slate-700" : "bg-slate-200 text-slate-700 dark:bg-slate-700 dark:text-slate-200"
                  }`}
                >
                  18+
                </span>
              ...
              {visit.appointment_only ? (
                <span className={`inline-flex items-center rounded-full px-3 py-1 text-xs font-semibold ${isLive ? "bg-sky-500/20 text-sky-200 dark:bg-sky-500/30 dark:text-sky-700" : "bg-sky-100 text-sky-700 dark:bg-sky-500/10 dark:text-sky-200"}`}>
                  Appointment only
                </span>
              ) : null}
              {visit.digital_payments ? (
                <span
                  className={`inline-flex items-center rounded-full px-3 py-1 text-xs font-semibold ${
                    isLive ? "bg-fuchsia-500/20 text-fuchsia-200 dark:bg-fuchsia-500/30 dark:text-fuchsia-700" : "bg-fuchsia-100 text-fuchsia-700 dark:bg-fuchsia-500/10 dark:text-fuchsia-200"
                  }`}
                >
                  Digital payments
                </span>
              ...
              {visit.custom_requests ? (
                <span
                  className={`inline-flex items-center rounded-full px-3 py-1 text-xs font-semibold ${
                    isLive ? "bg-violet-500/20 text-violet-200 dark:bg-violet-500/30 dark:text-violet-700" : "bg-violet-100 text-violet-700 dark:bg-violet-500/10 dark:text-violet-200"
                  }`}
                >
                  Custom requests
                </span>
        ...
        <div
          className={`h-px transition-all duration-300 ${
            isOpen ? "my-4 opacity-100" : "my-0 opacity-0"
          } ${isLive ? "bg-white/10 dark:bg-slate-200/70" : "bg-slate-200/70 dark:bg-slate-800/70"} sm:group-hover:my-4 sm:group-hover:opacity-100`}
        />
        ...
        <div className="text-center">
          {visitLocation ? (
            <div
              ...
              } ${isLive ? "text-white/50 dark:text-slate-500" : "text-slate-500 dark:text-slate-400"} sm:group-hover:text-[10px] sm:group-hover:tracking-[0.3em]`}
            >
          ...
          <div
            ...
            } ${isLive ? "text-white dark:text-slate-900" : "text-slate-900 dark:text-slate-100"} sm:group-hover:mt-2 sm:group-hover:text-[1.6rem] sm:group-hover:sm:text-3xl`}
          >
          ...
          {start ? (
            <div
              className={`transition-all duration-300 ${
                isOpen ? "mt-2 text-sm" : "mt-1 text-xs"
              } ${isLive ? "text-white/50 dark:text-slate-500" : "text-slate-500 dark:text-slate-400"} sm:group-hover:mt-2 sm:group-hover:text-sm`}
            >
        ...
        <div
          className={`grid gap-6 overflow-hidden transition-all duration-300 ${
            end ? "sm:grid-cols-2" : ""
          } ${isOpen ? "max-h-40 opacity-100" : "max-h-4 opacity-0"} sm:group-hover:max-h-40 sm:group-hover:opacity-100`}
        >
          <div>
